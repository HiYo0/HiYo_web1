...
public class ArticleController {
    ...
    public String edit(@PathVariable long id ,Model model){
        ...
        // 2. 응답결과를 뷰 탬플릿에게 보낼 준비 model
        model.addAttribute("article",form);
        // 3. 뷰 페이지 설정
        return "articles/edit";
    }
    // @PathVariable : 요청한 HTTP URL 경로상의 매개변수 대입 2. 자동타입변환
        // URL : /articles/{매겨변수명}/edit         , 예시] /articles/1/edit , /articles/2/edit
        // JAVA함수( @PathVariable("URL매개변수명") 타입 매개변수명 )
        //      URL 매개변수명 새략시 함수의 매개변수 명과 일치할경우 자동 대입

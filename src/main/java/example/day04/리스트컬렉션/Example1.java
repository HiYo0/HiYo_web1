    ...
    public static void main(String[] args) {//main start
        ...
        // 1. List
            ...
            // - ArrayList , Vector , LinkedList 클래스
                // 동기화 : 여러 스레드가 하나의 함수를 동시에 호출했을때 호출순서대로 해당함수를 끝날때까지 점유 상태
                // ArrayList : [배열구조]동기화 지원 X
        ...
        // 제공하는 함수
            ...
            // 4. 리스트객체명.size()                : 리스트내 저장된 전채 객체 수를 반환
            ...
            // 9. 리스트객체명.list.clear()           : 리스트내 저장된 객체를 삭제
